...
def main():
   ...
   # better_draw_circles(rg.Point(0,0),9)
    even_better_draw_circles(rg.Point(0,0),15,12,'red',4)
    even_better_draw_circles(rg.Point(100,100),7,15,'gold',9)
...
def even_better_draw_circles(point,radii,conc,color,thick):
    ...
    for k in range(1, conc+1):  # k becomes 1, 2, 3, ... 10
